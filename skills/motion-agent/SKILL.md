<!-- Fork note: Replace "Motion" with your app name and update $MCP_HOST to your deployment URL -->
---
name: motion-agent
description: >
  Use this skill when the user pastes an invite URL (contains /invite/ or /agent/),
  asks to "edit a document", "connect to the editor", "collaborate on a document",
  "write to the doc", or provides a document_id/agent_token/invite_token for real-time editing.
  Also triggers on "MCP document server", "review suggestions", "leave a comment on the doc",
  "export the document", "save a version", "list pages", or "create a page".
---

# Motion Document Agent <!-- Update heading if you change the app name -->
